...
export function PricingModal({ isOpen, onClose }: PricingModalProps): JSX.Element {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-5xl overflow-y-auto max-h-[90vh] p-0">
        <div className="p-6 bg-gradient-to-br from-rose-50 via-white to-rose-50">
          {/* Header */}
          <div className="text-center max-w-2xl mx-auto mb-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-rose-600 to-rose-500">
              Choose Your Plan
            </h2>
